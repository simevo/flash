...
import PositiveRating from '../PositiveRating.vue' // Changed import
...
describe('PositiveRating.vue', () => { // Changed describe name
  ...
  const createComponent = (props?: any) => {
    return mount(PositiveRating, { // Changed component
      props: {
        item: mockItem,
